          ...
          transition={{duration: 0.1, delay:0.4}}
            className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl '> 
              {infoList.map(({icon, iconDark, title, description}, index)=>(
                ...
                className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer a hover:-translate-y-1 duration-500  hover:shadow-md hover:shadow-black hover:bg-lightHover dark:border-white dark:hover:shadow-white dark:hover:bg-gray-800'  key={index} >
